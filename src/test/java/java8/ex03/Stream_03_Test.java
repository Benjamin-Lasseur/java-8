...
public class Stream_03_Test {
	...
	public void test_joining() throws Exception {
		...
		String result = customers.stream().map(cus -> cus.getFirstname()).sorted().collect(Collectors.joining("|"));
	...
	public void test_mapping() throws Exception {
		...
		// clients
		Map<Gender, String> result = customers.stream().sorted(Comparator.comparing(Customer::getFirstname)).collect(Collectors.groupingBy(Customer::getGender,
